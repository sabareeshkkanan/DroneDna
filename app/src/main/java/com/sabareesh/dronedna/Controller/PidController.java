...
/**
 * Created by sabareesh on 8/23/15.
 */
public class PIDController {
    ...
    private double m_maximumInput = 0.0;                // maximum input - boundControl setpoint to this
    private double m_minimumInput = 0.0;                // minimum input - boundControl setpoint to this
    ...
    private boolean boundControl=true;
    ...
    public boolean isBoundControl() {
        return boundControl;
    }

    public void setBoundControl(boolean boundControl) {
